...
@section('title', 'Customer Servers')
    ...
    <div class="card p-4 my-2 main-card">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between">
                <h2>Customer Servers</h2>
                <input type="text" class="form-control main-search" id="main-search" placeholder="Search">
            </div>
            <div class="d-flex justify-content-between align-items-center my-3">
                <div class="tabs d-flex">
                    <button class="blue-btn m-0 px-4 active" onclick="window.location.href='/customer/servers'">Servers</button>
                    <button class="blue-btn m-0 px-4"
        ...
        <div class="modal-dialog modal-md modal-dialog-centered border-0">
            <div class="modal-content border-0 p-2">
                <div class="modal-body p-4">
                    ...
                    <hr>
                    <form action="{{ route('customer.servers.store') }}" method="post">
                        @csrf
            ...
            function actions() {
                ...
                $('.deleteBtn').on('click', function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: '/customer/servers/delete/' + id,
                                type: 'GET',
                                success: function(response) {
                                    if (response.success) {
                                        list();
                ...
                $('.btnRenew').click(function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: '/customer/servers/renew/' + id + '/' + month,
                                type: 'GET',
                                success: function(response) {
                                    if (response.success) {
                                        list();
